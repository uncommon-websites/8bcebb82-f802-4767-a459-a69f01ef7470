<footer class="bg-[#050505] text-white pt-24 pb-12 border-t border-white/10">
    <div class="container mx-auto px-6">
        ...
        <div class="flex flex-col items-center text-center mb-24">
            <h2 class="text-4xl md:text-5xl font-bold mb-6 tracking-tight">Your African market<br>expansion starts here</h2>
            <p class="text-gray-400 mb-8 max-w-xl">For businesses ready to scale across Africa, there's Mookh. Start accepting payments today and unlock new markets tomorrow.</p>
            <button class="bg-[var(--color-mookh-primary)] hover:bg-[var(--color-mookh-primary-hover)] text-white px-8 py-3 rounded-full font-medium transition-colors flex items-center gap-2">
                Get started
        ...
        <div class="grid grid-cols-2 md:grid-cols-6 gap-8 mb-16 border-t border-white/10 pt-16">
            ...
            <div>
                ...
                <ul class="space-y-3 text-sm text-gray-400">
                    <li><a href="#" class="hover:text-white">Mobile Money</a></li>
                    <li><a href="#" class="hover:text-white">Payment Processing</a></li>
                    <li><a href="#" class="hover:text-white">Compliance</a></li>
                    <li><a href="#" class="hover:text-white">Multi-Currency</a></li>
                    <li><a href="#" class="hover:text-white">Analytics</a></li>
                    <li><a href="#" class="hover:text-white">Fraud Protection</a></li>
                </ul>
            </div>

            <div>
                <h4 class="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-4">Markets</h4>
                <ul class="space-y-3 text-sm text-gray-400">
                    <li><a href="#" class="hover:text-white">Nigeria</a></li>
                    <li><a href="#" class="hover:text-white">Kenya</a></li>
                    <li><a href="#" class="hover:text-white">South Africa</a></li>
                    <li><a href="#" class="hover:text-white">Ghana</a></li>
                    <li><a href="#" class="hover:text-white">View All Markets</a></li>
                </ul>
            </div>
